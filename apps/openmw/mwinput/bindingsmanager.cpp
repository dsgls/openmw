...
namespace MWInput
{
    ...
    std::string_view BindingsManager::getActionDescription(int action)
    {
        switch (action)
        {
            ...
            case A_ToggleFavorite:
                return "#{OMWEngine:ToggleFavorite}";
            case A_QuickKey1:
                return "#{sQuick1Cmd}";
            case A_QuickKey2:
                return "#{sQuick2Cmd}";
    ...
    const std::initializer_list<int>& BindingsManager::getActionControllerSorting()
    {
        static const std::initializer_list<int> actions{ A_MoveForward, A_MoveBackward, A_MoveLeft, A_MoveRight,
            ...
            A_QuickKeysMenu, A_QuickEquipMenu, A_ToggleFavorite, A_QuickKey1, A_QuickKey2, A_QuickKey3, A_QuickKey4, A_QuickKey5, A_QuickKey6, A_QuickKey7,
